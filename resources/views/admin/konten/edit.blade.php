                    ...
                    <div class="col-3">
                        <div class="position-relative">
                            ...
                            <div class="form-check position-absolute top-0 start-0 m-1">
                                <input class="form-check-input" type="checkbox" name="delete_medias[]" value="{{ $media->id }}" title="Hapus">
                            </div>
                        </div>
                    </div>
                    @endforeach
                </div>
                <p class="text-muted small mb-2"><i class="bi bi-info-circle"></i> Centang untuk menghapus media.</p>
                @endif
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="date" name="tanggal_mulai" class="form-control"
                        value="{{ old('tanggal_mulai', $konten->tanggal_mulai?->format('Y-m-d')) }}">
                </div>
                <div class="mb-3">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body">
                <div class="d-flex justify-content-between text-muted small">
                    <span>Dibuat:</span><strong>{{ $konten->created_at->format('d M Y') }}</strong>
                </div>
                <div class="d-flex justify-content-between text-muted small mt-1">
                    <span>Views:</span><strong>{{ number_format($konten->views) }}</strong>
                </div>
            </div>
        </div>
