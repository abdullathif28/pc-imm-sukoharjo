...
<head>
    ...
    {{-- SEO & Open Graph --}}
    <title>@yield('title', 'Beranda') | PC IMM Sukoharjo</title>
    <meta name="description" content="@yield('meta_description', 'Website Resmi PC IMM Sukoharjo — Pimpinan Cabang Ikatan Mahasiswa Muhammadiyah Sukoharjo. Religiusitas, Intelektualitas, Humanitas.')">
    ...
    {{-- Open Graph --}}
    <meta property="og:title" content="@yield('og_title', 'PC IMM Sukoharjo')">
    <meta property="og:description" content="@yield('og_description', 'Pimpinan Cabang Ikatan Mahasiswa Muhammadiyah Sukoharjo')">
    ...
    <meta name="twitter:title" content="@yield('og_title', 'PC IMM Sukoharjo')">
    <meta name="twitter:description" content="@yield('og_description', 'Pimpinan Cabang Ikatan Mahasiswa Muhammadiyah Sukoharjo')">
    ...
    {{-- Fonts: Playfair Display + DM Sans — karakter kuat, beda dari Inter --}}
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-1">
                <li class="nav-item">
                    <a class="nav-link nav-link-imm {{ request()->routeIs('home') ? 'active' : '' }}" href="{{ route('home') }}">Beranda</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-imm {{ request()->routeIs('tentang*') ? 'active' : '' }}" href="{{ route('tentang') }}">Tentang</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-imm {{ request()->routeIs('bidang*') ? 'active' : '' }}" href="{{ route('bidang') }}">Bidang</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-imm {{ request()->routeIs('komisariat*') ? 'active' : '' }}" href="{{ route('komisariat') }}">Komisariat</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link nav-link-imm dropdown-toggle {{ request()->routeIs('konten*') ? 'active' : '' }}" href="#" data-bs-toggle="dropdown">Konten</a>
                    <ul class="dropdown-menu border-0 shadow-lg">
                        <li><a class="dropdown-item" href="{{ route('konten', ['jenis' => 'berita']) }}"><i class="bi bi-newspaper me-2" style="color:var(--c-red)"></i>Berita</a></li>
                        <li><a class="dropdown-item" href="{{ route('konten', ['jenis' => 'kegiatan']) }}"><i class="bi bi-calendar-event me-2" style="color:var(--c-gold)"></i>Kegiatan</a></li>
                        <li><a class="dropdown-item" href="{{ route('konten', ['jenis' => 'program_kerja']) }}"><i class="bi bi-list-check me-2" style="color:var(--c-red)"></i>Program Kerja</a></li>
                        <li><hr class="dropdown-divider" style="opacity:0.1;"></li>
                        <li><a class="dropdown-item" href="{{ route('konten') }}"><i class="bi bi-grid me-2" style="color:var(--c-muted)"></i>Semua Konten</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item ms-lg-2 d-flex align-items-center gap-2">
                    ...
                    @auth
                        @if(auth()->user()->isSuperAdmin())
                            <a class="btn-nav-cta nav-link" href="{{ route('super-admin.dashboard') }}">
                                <i class="bi bi-shield-fill me-1"></i>Admin Panel
                            </a>
                        @else
                            <a class="btn-nav-cta nav-link" href="{{ route('admin.dashboard') }}">
                    ...
                    @else
                        <a class="btn-nav-cta nav-link" href="{{ route('login') }}">
...
<footer class="footer-imm">
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-2 col-md-4">
                ...
                <ul class="list-unstyled d-flex flex-column gap-2">
                    <li><a class="footer-link" href="{{ route('home') }}">Beranda</a></li>
                    <li><a class="footer-link" href="{{ route('tentang') }}">Tentang IMM</a></li>
                    <li><a class="footer-link" href="{{ route('bidang') }}">Bidang</a></li>
                    <li><a class="footer-link" href="{{ route('komisariat') }}">Komisariat</a></li>
                    <li><a class="footer-link" href="{{ route('konten') }}">Konten</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <ul class="list-unstyled d-flex flex-column gap-2">
                    <li><a class="footer-link" href="{{ route('konten', ['jenis' => 'berita']) }}">Berita</a></li>
                    <li><a class="footer-link" href="{{ route('konten', ['jenis' => 'kegiatan']) }}">Kegiatan</a></li>
                    <li><a class="footer-link" href="{{ route('konten', ['jenis' => 'program_kerja']) }}">Program Kerja</a></li>
                </ul>
            </div>
        ...
        <div class="footer-bottom d-flex justify-content-between align-items-center flex-wrap gap-2">
            <span>© {{ date('Y') }} PC IMM Sukoharjo. All rights reserved.</span>
...
{{-- ===== FLOATING SHARE ===== --}}
@hasSection('show_share')
<div id="float-share">
    <a href="https://wa.me/?text={{ urlencode(request()->url()) }}" target="_blank" class="share-btn-float share-wa" title="Share WhatsApp">
        <i class="bi bi-whatsapp"></i>
    </a>
    <button onclick="navigator.clipboard.writeText('{{ request()->url() }}');this.innerHTML='<i class=\'bi bi-check2\'></i>';setTimeout(()=>this.innerHTML='<i class=\'bi bi-link-45deg\'></i>',2000)" class="share-btn-float share-copy" title="Salin Link">
