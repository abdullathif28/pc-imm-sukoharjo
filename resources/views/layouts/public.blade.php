...
<head>
    ...
    <title>@yield('title', 'PC IMM Sukoharjo') | PC IMM Sukoharjo</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-1">
                ...
                <li class="nav-item"><a class="nav-link px-3 {{ request()->routeIs('bidang*') ? 'active' : '' }}" href="{{ route('bidang') }}">Bidang</a></li>
                <li class="nav-item dropdown">
                    <a class="nav-link px-3 dropdown-toggle {{ request()->routeIs('konten*') ? 'active' : '' }}" href="#" data-bs-toggle="dropdown">Konten</a>
                    <ul class="dropdown-menu border-0 shadow-lg" style="border-radius:12px;">
                        <li><a class="dropdown-item" href="{{ route('konten', ['jenis' => 'berita']) }}"><i class="bi bi-newspaper me-2 text-primary"></i>Berita</a></li>
                        <li><a class="dropdown-item" href="{{ route('konten', ['jenis' => 'kegiatan']) }}"><i class="bi bi-calendar-event me-2 text-success"></i>Kegiatan</a></li>
                        <li><a class="dropdown-item" href="{{ route('konten', ['jenis' => 'program_kerja']) }}"><i class="bi bi-list-check me-2 text-warning"></i>Program Kerja</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="{{ route('konten') }}"><i class="bi bi-grid me-2"></i>Semua Konten</a></li>
                    </ul>
                </li>
                @auth
                    <li class="nav-item ms-lg-2 d-flex align-items-center gap-2">
                        @if(auth()->user()->isSuperAdmin())
                            <a class="btn btn-imm-yellow btn-sm px-3 py-2" href="{{ route('super-admin.dashboard') }}">
                                <i class="bi bi-shield-fill me-1"></i>Panel Admin
                            </a>
                        @else
                            <a class="btn btn-imm-yellow btn-sm px-3 py-2" href="{{ route('admin.dashboard') }}">
                ...
                @else
                    <li class="nav-item ms-lg-2">
                        <a class="btn btn-imm-yellow btn-sm px-4 py-2" href="{{ route('login') }}">
...
<footer class="footer-main pt-5 pb-0 mt-5">
        ...
        <div class="row g-4 pb-4">
            ...
            <div class="col-lg-2 col-md-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a class="footer-link" href="{{ route('home') }}">Beranda</a></li>
                    <li class="mb-2"><a class="footer-link" href="{{ route('bidang') }}">Bidang</a></li>
                    <li class="mb-2"><a class="footer-link" href="{{ route('konten') }}">Konten</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-4">
                <h6 class="text-white fw-700 mb-3" style="font-weight:700;">Konten</h6>
                <ul class="list-unstyled">
                    <li class="mb-2"><a class="footer-link" href="{{ route('konten', ['jenis' => 'berita']) }}"><i class="bi bi-newspaper me-2"></i>Berita</a></li>
                    <li class="mb-2"><a class="footer-link" href="{{ route('konten', ['jenis' => 'kegiatan']) }}"><i class="bi bi-calendar-event me-2"></i>Kegiatan</a></li>
                    <li class="mb-2"><a class="footer-link" href="{{ route('konten', ['jenis' => 'program_kerja']) }}"><i class="bi bi-list-check me-2"></i>Program Kerja</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-4">
    ...
    <div class="footer-bottom text-center py-3">
        <p class="mb-0 text-white-50">© {{ date('Y') }} PC IMM Sukoharjo. All rights reserved. | <em>Berjuang untuk Kemajuan Umat</em></p>
    </div>
</footer>
