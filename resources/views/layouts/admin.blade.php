...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        @if(auth()->user()->isSuperAdmin())
            ...
            <a href="{{ route('super-admin.pengurus.index') }}" class="sidebar-link {{ request()->routeIs('super-admin.pengurus*') ? 'active' : '' }}">
                <i class="bi bi-person-badge-fill"></i> Pengurus
            </a>
            <a href="{{ route('super-admin.komisariat.index') }}" class="sidebar-link {{ request()->routeIs('super-admin.komisariat*') ? 'active' : '' }}">
            ...
            <a href="{{ route('super-admin.timeline.index') }}" class="sidebar-link {{ request()->routeIs('super-admin.timeline*') ? 'active' : '' }}">
