...
<body>
    <div class="login-card">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group shadow-sm" style="border-radius: 12px;">
                        ...
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                            placeholder="admin@pcimm-sukoharjo.org" value="{{ old('email') }}" required autofocus>
                    </div>
                </div>
                <div class="mb-4">
        ...
        <div class="back-link">
            <a href="{{ route('home') }}"><i class="bi bi-house-door-fill me-2"></i>Kembali ke Beranda Utama</a>
        </div>
    </div>
