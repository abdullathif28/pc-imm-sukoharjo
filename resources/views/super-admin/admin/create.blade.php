    ...
    <div class="col-lg-7">
        <div class="card">
            <div class="card-header d-flex align-items-center gap-2">
                ...
                <h6 class="mb-0 fw-700" style="font-weight:700;">Form Tambah Admin Bidang</h6>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{ route('super-admin.admin.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-3">
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <input type="email" name="email" class="form-control" value="{{ old('email') }}" required placeholder="email@pcimm-sukoharjo.org">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-600 small" style="font-weight:600;">Password <span class="text-danger">*</span></label>
                            <input type="password" name="password" class="form-control" required minlength="8" placeholder="Min. 8 karakter">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-600 small" style="font-weight:600;">Konfirmasi Password <span class="text-danger">*</span></label>
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <button type="submit" class="btn btn-primary"><i class="bi bi-person-plus me-2"></i>Tambah Admin</button>
