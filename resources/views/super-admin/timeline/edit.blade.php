...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-1">Edit Timeline</h4>
        <p class="text-muted mb-0 small">{{ $timeline->judul }}</p>
    </div>
...
<div class="card">
    <div class="card-body p-4">
        <form action="{{ route('super-admin.timeline.update', $timeline) }}" method="POST">
            @csrf @method('PUT')
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="text" name="tahun" class="form-control @error('tahun') is-invalid @enderror"
                           value="{{ old('tahun', $timeline->tahun) }}" required>
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" name="urutan" class="form-control" value="{{ old('urutan', $timeline->urutan) }}" min="0">
                </div>
                <div class="col-12">
                    <label class="form-label fw-semibold">Deskripsi</label>
                    <textarea name="deskripsi" class="form-control" rows="3">{{ old('deskripsi', $timeline->deskripsi) }}</textarea>
                </div>
                <div class="col-12">
