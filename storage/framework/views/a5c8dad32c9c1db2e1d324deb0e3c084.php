<?php $__env->startSection('title', 'Konten Saya'); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-1">Konten — <?php echo e(auth()->user()->bidang->nama); ?></h4>
        <p class="text-muted mb-0">Kelola berita, kegiatan, dan program kerja bidang Anda</p>
    </div>
    <a href="<?php echo e(route('admin.konten.create')); ?>" class="btn btn-primary">
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body">
        <form method="GET" action="<?php echo e(route('admin.konten.index')); ?>" class="row g-2">
            <div class="col-md-3">
...
<div class="card border-0 shadow-sm">
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <?php else: ?>
                                    <div class="rounded d-flex align-items-center justify-content-center text-white"
                                        style="width:50px;height:50px;background:<?php echo e(auth()->user()->bidang->warna ?? '#6c757d'); ?>">
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-1">
                                ...
                                <a href="<?php echo e(route('admin.konten.edit', $konten)); ?>" class="btn btn-sm btn-outline-primary" title="Edit">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <form action="<?php echo e(route('admin.konten.destroy', $konten)); ?>" method="POST" onsubmit="return confirm('Hapus konten ini?')">
                    ...
                    <tr>
                        <td colspan="7" class="text-center py-5 text-muted">
                            ...
                            Belum ada konten. <a href="<?php echo e(route('admin.konten.create')); ?>">Tambah sekarang?</a>
                        </td>
                    </tr>
                    <?php endif; ?>
                </tbody>
    ...
    <div class="card-footer bg-transparent"><?php echo e($kontens->links()); ?></div>
    <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\M S I\Downloads\pc-imm-sukoharjo\resources\views/admin/konten/index.blade.php ENDPATH**/ ?>