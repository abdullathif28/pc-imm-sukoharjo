...
<?php $__env->startSection('og_title', 'PC IMM Sukoharjo — Religiusitas, Intelektualitas, Humanitas'); ?>
<?php $__env->startSection('og_description', 'Website resmi Pimpinan Cabang Ikatan Mahasiswa Muhammadiyah Sukoharjo.'); ?>
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-7" data-aos="fade-right" data-aos-duration="800">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <a href="<?php echo e(route('konten')); ?>" class="btn-primary-imm">
                        <i class="bi bi-newspaper"></i> Jelajahi Konten
                    </a>
                    <a href="<?php echo e(route('tentang')); ?>" class="btn-outline-imm" style="border-color:rgba(255,255,255,0.4);color:white;">
            ...
            <div class="col-lg-5" data-aos="fade-left" data-aos-delay="200" data-aos-duration="800">
                <div class="hero-stats-panel">
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="stat-item">
                                <div class="stat-number" data-count="<?php echo e($stats['total_bidang']); ?>">0</div>
                                <div class="stat-label">Bidang Aktif</div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="stat-item">
                                <div class="stat-number" data-count="<?php echo e($stats['total_konten']); ?>">0</div>
                                <div class="stat-label">Total Konten</div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="stat-item">
                                <div class="stat-number" data-count="<?php echo e($stats['total_berita']); ?>">0</div>
                                <div class="stat-label">Berita</div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="stat-item">
                                <div class="stat-number" data-count="<?php echo e($stats['total_kegiatan']); ?>">0</div>
                                <div class="stat-label">Kegiatan</div>
                            </div>
                        </div>
                    </div>
                    <div class="mt-3 pt-3" style="border-top:1px solid rgba(255,255,255,0.08);text-align:center;">
                        <a href="<?php echo e(route('komisariat')); ?>" style="font-size:0.8rem;color:rgba(255,255,255,0.5);text-decoration:none;transition:color 0.2s;" onmouseover="this.style.color='var(--c-gold)'" onmouseout="this.style.color='rgba(255,255,255,0.5)'">
...
<section class="section-wrap geo-pattern">
    <div class="container">
        <div class="d-flex justify-content-between align-items-end mb-5" data-aos="fade-up">
            ...
            <a href="<?php echo e(route('konten', ['jenis' => 'berita'])); ?>" class="btn-outline-imm" style="font-size:0.85rem;padding:0.5rem 1.2rem;">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="<?php echo e($index * 80); ?>">
                <a href="<?php echo e(route('konten.detail', $berita->slug)); ?>" class="news-card">
                    <?php if($berita->thumbnail): ?>
                        <img src="<?php echo e(asset('storage/'.$berita->thumbnail)); ?>" class="news-card-img" alt="<?php echo e($berita->judul); ?>">
                    <?php else: ?>
                    ...
                    <div class="news-card-body">
                        <div class="news-meta">
                            <span class="badge-jenis badge-berita"><?php echo e($berita->bidang->singkatan ?? 'IMM'); ?></span>
                            <span style="font-size:0.75rem;color:var(--c-muted);"><?php echo e($berita->created_at->diffForHumans()); ?></span>
                        </div>
                        <div class="news-title"><?php echo e($berita->judul); ?></div>
                        <div class="news-excerpt"><?php echo e($berita->ringkasan ?: Str::limit(strip_tags($berita->isi), 100)); ?></div>
                    </div>
                </a>
            </div>
...
<section class="section-wrap section-wrap-alt">
    <div class="container">
        ...
        <div class="bidang-grid">
            ...
            ?>
            <?php $__currentLoopData = $bidangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bidang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('bidang.detail', $bidang)); ?>" class="bidang-card-new" data-aos="fade-up" data-aos-delay="<?php echo e(($index % 3) * 80); ?>">
                <div class="bidang-icon-wrap" style="background: <?php echo e($bidangColors[$index % count($bidangColors)]); ?>;">
                    <?php echo e($bidangIcons[$index % count($bidangIcons)]); ?>

                </div>
                <div class="bidang-singkatan"><?php echo e($bidang->singkatan); ?></div>
                <div class="bidang-nama"><?php echo e($bidang->nama); ?></div>
                <div class="bidang-desc"><?php echo e(Str::limit($bidang->deskripsi, 90)); ?></div>
                <div class="d-flex align-items-center justify-content-between">
                    <span class="bidang-count-pill">
                        <i class="bi bi-file-text"></i> <?php echo e($bidang->kontens_count); ?> konten
                    </span>
    ...
    <div class="container">
        <div class="row g-5 align-items-start">
            <div class="col-lg-4" data-aos="fade-right">
                ...
                <a href="<?php echo e(route('konten', ['jenis' => 'kegiatan'])); ?>" class="btn-outline-imm">
                    Semua Kegiatan <i class="bi bi-arrow-right"></i>
                </a>
            </div>
            <div class="col-lg-8">
                <div class="d-flex flex-column gap-3">
                    <?php $__empty_1 = true; $__currentLoopData = $kegiatanTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $kegiatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <a href="<?php echo e(route('konten.detail', $kegiatan->slug)); ?>" class="event-card" data-aos="fade-left" data-aos-delay="<?php echo e($index * 80); ?>">
                        <div class="event-date-block">
                            <?php if($kegiatan->tanggal_mulai): ?>
                                <div class="event-day"><?php echo e($kegiatan->tanggal_mulai->format('d')); ?></div>
                                <div class="event-month"><?php echo e($kegiatan->tanggal_mulai->format('M')); ?></div>
                            <?php else: ?>
                                <div class="event-day" style="font-size:1.5rem;">—</div>
                            <?php endif; ?>
                        </div>
                        <div class="event-body">
                            <span class="badge-jenis badge-kegiatan" style="margin-bottom:0.5rem;display:inline-block;"><?php echo e($kegiatan->bidang->singkatan ?? 'IMM'); ?></span>
                            <div class="event-title"><?php echo e($kegiatan->judul); ?></div>
    ...
    <div class="container">
        ...
        <div class="gallery-grid" data-aos="fade-up">
            ...
            <div class="gallery-item">
                <?php if(isset($galeriItems[$i])): ?>
                    <img src="<?php echo e(asset('storage/'.$galeriItems[$i]->file_path)); ?>" alt="Galeri IMM">
...
<section class="cta-section">
    <div class="container text-center position-relative" style="z-index:2;" data-aos="fade-up">
        ...
        <div class="d-flex justify-content-center gap-3 flex-wrap">
            <a href="<?php echo e(route('tentang')); ?>" class="btn-primary-imm" style="background:linear-gradient(135deg,var(--c-gold),#E65100);color:#1A0A0A;">
                <i class="bi bi-info-circle"></i> Tentang IMM
            </a>
            <a href="<?php echo e(route('komisariat')); ?>" class="btn-outline-imm" style="border-color:rgba(255,255,255,0.3);color:white;">
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\M S I\Downloads\pc-imm-sukoharjo\resources\views/public/home.blade.php ENDPATH**/ ?>