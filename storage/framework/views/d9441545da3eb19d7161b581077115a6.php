        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-7" data-aos="fade-right">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <a href="<?php echo e(route('konten')); ?>" class="btn btn-hero-primary">
                        <i class="bi bi-newspaper me-2"></i>Lihat Konten
                    </a>
                    <a href="<?php echo e(route('bidang')); ?>" class="btn btn-hero-outline">
                ...
                <div class="row g-3">
                    <div class="col-6">
                        <div class="hero-stat-card p-3">
                            <div class="hero-stat-number"><?php echo e($stats['total_bidang']); ?></div>
                            <div class="text-white-50 small">Bidang Aktif</div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="hero-stat-card p-3">
                            <div class="hero-stat-number"><?php echo e($stats['total_konten']); ?></div>
                            <div class="text-white-50 small">Total Konten</div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="hero-stat-card p-3">
                            <div class="hero-stat-number"><?php echo e($stats['total_berita']); ?></div>
                            <div class="text-white-50 small">Berita</div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="hero-stat-card p-3">
                            <div class="hero-stat-number"><?php echo e($stats['total_kegiatan']); ?></div>
...
<section class="py-5 bg-imm-light">
    <div class="container">
        <div class="d-flex justify-content-between align-items-end mb-4">
            ...
            <a href="<?php echo e(route('konten', ['jenis' => 'berita'])); ?>" class="btn btn-outline-imm btn-sm px-3" data-aos="fade-left">
        ...
        <div class="row g-4">
            <?php $__empty_1 = true; $__currentLoopData = $beritaTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $berita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="<?php echo e($index * 100); ?>">
                    <a href="<?php echo e(route('konten.detail', $berita->slug)); ?>" class="text-decoration-none">
                        <div class="card card-custom h-100">
                            <div class="position-relative">
                                <?php if($berita->thumbnail): ?>
                                    <img src="<?php echo e(asset('storage/'.$berita->thumbnail)); ?>" class="card-img-top" alt="<?php echo e($berita->judul); ?>" style="height: 200px; object-fit: cover;">
                                <?php else: ?>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center gap-2 mb-3">
                                    <span class="badge px-2 py-1" style="background: rgba(198, 40, 40, 0.1); color: var(--imm-red); font-size:0.75rem;">
                                        <?php echo e($berita->bidang->singkatan ?? $berita->bidang->nama); ?>

                                    </span>
                                    <small class="text-muted"><i class="bi bi-clock me-1"></i><?php echo e($berita->created_at->diffForHumans()); ?></small>
                                </div>
                                <h5 class="card-title fw-bold line-clamp-2" style="color: var(--imm-dark); font-size:1.1rem;"><?php echo e($berita->judul); ?></h5>
                                <p class="card-text text-muted small line-clamp-3 mt-2"><?php echo e($berita->ringkasan ?: Str::limit(strip_tags($berita->isi), 120)); ?></p>
                            </div>
        ...
        <div class="row g-4">
            <?php $__currentLoopData = $bidangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bidang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="<?php echo e($index * 80); ?>">
                    <a href="<?php echo e(route('bidang.detail', $bidang)); ?>" class="bidang-card d-block p-4 bg-white shadow-sm text-decoration-none">
                        <div class="d-flex align-items-start gap-3 mb-3">
                            ...
                            <div class="flex-grow-1">
                                <span class="badge px-2 py-1 mb-1" style="background: rgba(198, 40, 40, 0.1); color: var(--imm-red); font-size:0.7rem; font-weight:700;">
                                    <?php echo e($bidang->singkatan); ?>

                                </span>
                                <h5 class="fw-bold mb-0" style="color: var(--imm-dark); font-size:1rem; line-height:1.3;"><?php echo e($bidang->nama); ?></h5>
                            </div>
                        </div>
                        <p class="text-muted small mb-3 line-clamp-2"><?php echo e($bidang->deskripsi); ?></p>
                        <div class="d-flex align-items-center justify-content-between pt-2 border-top">
                            <span class="small text-muted"><i class="bi bi-file-text me-1"></i><?php echo e($bidang->kontens_count); ?> konten</span>
...
<section class="py-5 bg-imm-light">
    <div class="container">
        <div class="d-flex justify-content-between align-items-end mb-4">
            ...
            <a href="<?php echo e(route('konten', ['jenis' => 'kegiatan'])); ?>" class="btn btn-outline-imm btn-sm px-3" data-aos="fade-left">
                Lihat Semua <i class="bi bi-arrow-right ms-1"></i>
            </a>
        </div>
        <div class="row g-4">
            <?php $__empty_1 = true; $__currentLoopData = $kegiatanTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $kegiatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="<?php echo e($index * 100); ?>">
                    <a href="<?php echo e(route('konten.detail', $kegiatan->slug)); ?>" class="text-decoration-none">
                        <div class="card card-custom h-100">
                            <div class="card-body">
                                <div class="d-flex gap-3 mb-3">
                                    <div class="date-box flex-shrink-0 text-center p-2 rounded-3" style="min-width:65px;">
                                        <div class="fw-bold text-imm-primary" style="font-size:1.5rem; line-height: 1;">
                                            <?php echo e($kegiatan->tanggal_mulai ? $kegiatan->tanggal_mulai->format('d') : '—'); ?>

                                        </div>
                                        <div class="small fw-bold mt-1" style="color: var(--imm-dark);">
                                            <?php echo e($kegiatan->tanggal_mulai ? $kegiatan->tanggal_mulai->format('M') : ''); ?>

                                        </div>
                                    </div>
                                    <div>
                                        <span class="badge bg-warning text-dark px-2 py-1 mb-2 shadow-sm" style="font-size: 0.7rem;">Kegiatan</span>
                                        <h5 class="card-title fw-bold mb-1 line-clamp-2" style="color: var(--imm-dark); font-size:1rem;"><?php echo e($kegiatan->judul); ?></h5>
                                        <?php if($kegiatan->lokasi): ?>
                                            <small class="text-muted"><i class="bi bi-geo-alt-fill text-imm-red me-1"></i><?php echo e($kegiatan->lokasi); ?></small>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <p class="text-muted small line-clamp-2 mt-2"><?php echo e($kegiatan->ringkasan ?: Str::limit(strip_tags($kegiatan->isi), 100)); ?></p>
                            </div>
                        </div>
                    </a>
                </div>
...
<section class="py-5 position-relative overflow-hidden" style="background: linear-gradient(135deg, var(--imm-red-dark), var(--imm-red));">
    ...
    <div class="container text-center position-relative" style="z-index: 2;" data-aos="fade-up">
        ...
        <div class="d-flex justify-content-center gap-3 flex-wrap mt-4">
            <a href="<?php echo e(route('konten')); ?>" class="btn px-4 py-3" style="background: var(--imm-yellow); color: var(--imm-red-dark); font-weight:700; border-radius:50px; box-shadow: 0 4px 15px rgba(251, 192, 45, 0.4); transition: transform 0.3s;">
                <i class="bi bi-newspaper me-2"></i>Baca Konten Kami
            </a>
            <a href="<?php echo e(route('bidang')); ?>" class="btn px-4 py-3" style="border:2px solid rgba(255,255,255,0.8); color:white; font-weight:600; border-radius:50px; transition: all 0.3s;">
